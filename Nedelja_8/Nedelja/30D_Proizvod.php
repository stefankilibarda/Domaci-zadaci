<?php 
    ...
    class Proizvod{
        ...
        function prikazi_proizvod(){
            ...
            echo "<a href='30D_detaljnije.php?id=$this->id'>Detaljnije</a>";
            echo "</div>";
        }
    ...
    class ListaProizvoda{
     ...
     class WebSite {
        ...
        public function header() {
            echo "<h1><a href='30D_index.php'>Dobro dosli u web-shop</a></h1>";
        }
        public function footer() {
            echo "<h1>Bolje vas nasli</h1>";
        }
        public function meni($podaci) {
            echo "<ul>";
            foreach($podaci as $podatak) {
                echo "<li><a href='30D_index.php?grupa=" . $podatak['grupa'] . "'>" . $podatak['grupa'] . "</a></li>";
            }
            echo "</ul>";
